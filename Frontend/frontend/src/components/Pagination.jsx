...
// Memoized component: Pagination is expensive to render (complex calculations)
// Only re-render if pagination parameters change
const Pagination = memo(function Pagination({ currentPage, totalPages, onPageChange }) {
  ...
  // Custom comparison: Only re-render if pagination values actually change
